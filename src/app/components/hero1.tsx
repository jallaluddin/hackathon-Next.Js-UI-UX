    ...
    <div className="flex flex-col pb-32 sm:flex-row h-[562px]   max-w-[1920px] w-full  bg-black">
      ...
      <div className="space-y-4 md:block hidden m-[5px] w-1/2 mt-8">
        <div className="flex  md:mr-[60px] gap-[12px] md:mt-[110px] sm:mt[50px] flex-col text-white">
          <div>
            <Image src='/images/hero01.png' width={660} height={330} alt="hero-egg" className="rounded-[6px] sm:h-[330px] h-[400]"/>
          </div>
          <div className="flex gap-[12px] md:mb-0 sm:mb-[25px]">
            <div><Image src='/images/hero02.png' width={322} height={194} alt="hero-egg" className="rounded-[6px] h-[250px] sm:h-[194px]"/></div>
            <div><Image src='/images/hero03.png' width={322} height={194} alt="hero-egg" className="rounded-[6px] h-[250px] sm:h-[194px]"/></div>
          </div>
        </div>
