    ...
    <div className="px-4 sm:px-8 lg:px-16 py-12">
      ...
      <div className="flex flex-col items-center text-center pb-8">
        <Image
          ...
          width={133}
          height={134}
          className="rounded-full relative mb-[-50px] z-10"
        />
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg z-10 relative">
          <PiQuotesLight
            size={47}
            className="text-orange-500 mt-10 mx-auto mb-4"
          />
          <p className="leading-relaxed text-[#4F4F4F] text-lg mb-6">
          ...
          <h2 className="text-[#333333] font-helvetica font-bold text-2xl mb-2">
            Alamin Hasan
          </h2>
